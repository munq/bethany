...
foreach($yag_retreats_args as $post_nav) {
	$yag_retreats_page_ids[] = $post_nav->ID;
}
//var_dump($yag_retreats_page_ids);
...
<section id="content" class="clearfix">
	...
	<section class="col-full wrapper clearfix">		
		...
		<section class="col-main">
			...
			$diff_ids = array_diff_assoc($yag_retreats_page_ids, $page_ids);
			if ( empty($diff_ids) ) {
				//var_dump("YAG Retreats");
			...
			<div class="view-all-section">
				<a class="view-all-message-series" href="<?php echo $series_path; ?> ">View all <?php echo $series_name; ?> messages</a>
			</div>
