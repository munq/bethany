			...
			if($query->have_posts()) {
				...
				while($query->have_posts()) {			
					...
					<li class="box-img g-<?php echo ($big_picture) ? 'two' : 'four'?>">
						<a href="<?php echo get_permalink($post_articles->ID); ?>">
							<figure>
