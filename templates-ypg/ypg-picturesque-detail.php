...
/**
 * Template Name: YPG Picturesque Detail
 *
 * @package Bethany
 * @subpackage bethany
 * @since bethany 1.0
...
<section id="content" class="clearfix">
	...
	<section class="col-full clearfix">
		<section class="col-full">
			<?php 				
			$picturesque_main_image = get_field('picturesque_main_image'); 
			if($picturesque_main_image) {				
				?>
				<div class="box-img">				
					<img src="<?php echo $picturesque_main_image; ?>" alt="" />
				</div>
			<?php	
			}	
			?>			
		...
		<section class="col-side">
			<div class="box-side">
				<div class="box-side-top clearfix">
					<h3>More on Picturesque</h3>
				</div>
				<div class="box-side-content">
					<ul class="grid-picturesque clearfix">
					<?php
					...
					$picturesques	= new WP_Query($args);
					
					if($picturesques->have_posts()) {
						while($picturesques->have_posts()) { 
							
							$picturesques->the_post();
							setup_postdata($post);
							$picturesque = $post;
							
							$side_image = get_field('side_image', $picturesque->ID); 
							
							?>							
							<li class="box-img"><a href="<?php echo get_permalink($picturesque->ID); ?>">
							<figure>
								<img src="<?php echo $side_image;?>" alt="" />
								<figcaption><p><?php echo get_the_title($picturesque->ID); ?></p></figcaption>
								</figure>
								</a>
							</li>
