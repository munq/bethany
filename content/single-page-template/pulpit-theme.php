<?php
// Get the necessary fields from the options page
                ...
                <div class="carousel-memory-verse">
                    ...
                    if ($query->have_posts()) {
                        while ($query->have_posts()) {
                            ...
                            $text_reference = get_field('text_reference', $memory_verse->ID);
                            ...
                            <div>
                                <div class="box-banner">
                                    ...
                                    <div class="box-banner-content">
                                        <strong><?php echo $memory_verse->post_title; ?></strong>
                                        <blockquote>
                                            <p><?php echo $verse_quote; ?></p>
                                            <span><?php echo $text_reference; ?></span>
                                        </blockquote>
                                        <?php if ($verse_content) { ?>
                                ...
                                <div class="lightbox-content" id="memory-verse_<?php echo $memory_verse->ID; ?>">
                                    <div class="wrapper">
                                        <h2>Memory Verse</h2>
                                        <h3>
                                            <small><?php echo date('d F Y', strtotime($verse_date)) ?></small>
                                        </h3>
                                        <!-- Full-width Column -->
                                        <section class="col-full clearfix">
                                            <blockquote>
